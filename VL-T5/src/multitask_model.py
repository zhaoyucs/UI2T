...
from vsd_model import VLBartVSD
...
class VLBartMultiTask(VLBart):
    ...
    def train_step(self, batch, **kwargs):
        ...
        if task == 'vqa':
            ...
            return VLBartVSD.train_step(self, batch, **kwargs)
    ...
    def valid_step(self, batch, **kwargs):
        ...
        if task == 'vqa':
            ...
            return VLBartVSD.valid_step(self, batch, **kwargs)
    ...
    def test_step(self, batch, **kwargs):
        ...
        if task == 'vqa':
            ...
            return VLBartVSD.test_step(self, batch, **kwargs)
