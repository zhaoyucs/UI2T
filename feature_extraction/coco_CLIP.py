...
import sys
sys.path.append("/storage/yzhao/repositories/VL_adapter/VL-T5/src")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', default='RN101', type=str, help='RN50, RN101, RN50x4, ViT-B/32, vit_base_patch32_224_in21k')
